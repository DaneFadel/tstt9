		...
		if(Index < 12)
		{
			...
			if(Index==EQUIPMENT_HELPER)
			{
                if ( gMapManager.InChaosCastle()==false )
                {
                    ...
                    case ITEM_HELPER+2:CreateMount(MODEL_UNICON  ,o->Position,o);
                        if(!Hero->SafeZone)
                            CreateEffect(BITMAP_MAGIC+1,o->Position,o->Angle,o->Light,1,o);
                        break;
                    case ITEM_HELPER+3:CreateMount(MODEL_PEGASUS, o->Position,o);
                        if(!Hero->SafeZone)
                            CreateEffect(BITMAP_MAGIC+1,o->Position,o->Angle,o->Light,1,o);
                        break;
                    case ITEM_HELPER+4:CreateMount(MODEL_DARK_HORSE ,o->Position,o);
                        if(!Hero->SafeZone)
                            CreateEffect(BITMAP_MAGIC+1,o->Position,o->Angle,o->Light,1,o);
                        break;
					case ITEM_HELPER+37:
