...
BOOL CreateSocket(char *IpAddr, unsigned short Port) 
{
	...
	{
		g_ConsoleDebug->Write(MCD_NORMAL, "Failed to connect.");
...
{
	LPPRECEIVE_NEW_CHARACTER_INFO_SEND Data = (LPPRECEIVE_NEW_CHARACTER_INFO_SEND)ReceiveBuffer;
	...
	CharacterAttribute->Vitality = Data->Vitality;
	CharacterAttribute->Energy = Data->Energy;
	//CharacterAttribute->Leadership = Data->Leadership;
	CharacterAttribute->Life = Data->Life;
	CharacterAttribute->LifeMax = Data->MaxLife;
	CharacterAttribute->Mana = Data->Mana;
	CharacterAttribute->ManaMax = Data->MaxMana;
	//CharacterAttribute->BP = Data->BP;
	//CharacterAttribute->MaxBP = Data->MaxBP;
	CharacterAttribute->Shield = Data->Shield;
	CharacterAttribute->ShieldMax = Data->MaxShield;
	CharacterAttribute->AddPoint = Data->FruitAddPoint;
	CharacterAttribute->MaxAddPoint = Data->MaxFruitAddPoint;
	//CharacterAttribute->FruitSubPoint = Data->FruitSubPoint;
	//CharacterAttribute->MaxFruitSubPoint = Data->MaxFruitSubPoint;
	...
	case 0xF3:     			
		{
			...
			case 0x06: //receive Add Point
				...
				break;
			case 0xE0: //receive Character Info
				ReceiveCharacterInfo(ReceiveBuffer);
				break;
