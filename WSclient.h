...
}PRECEIVE_NEW_CHARACTER_INFO_SEND, *LPPRECEIVE_NEW_CHARACTER_INFO_SEND;

typedef struct
{
	PBMSG_HEADER header; // C1:F3:E1
	DWORD ViewCurHP;
	DWORD ViewMaxHP;
	DWORD ViewCurMP;
	DWORD ViewMaxMP;
...
} PRECEIVE_NEW_CHARACTER_CALC_SEND, *LPPRECEIVE_NEW_CHARACTER_CALC_SEND;
