		...
		if (!o->Live)
		{
			...
			case MODEL_EFFECT_FLAME_STRIKE:
				if (o->SubType == 0)
				{
					o->Alpha = 0;
					o->LifeTime = 35;
					o->Velocity = Models[o->Owner->Type].Actions[PLAYER_SKILL_FLAMESTRIKE].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
					o->AI = 0;
					o->m_iAnimation = rand();
				}
				break;
			...
			case MODEL_WOLF_HEAD_EFFECT:
			{
				...
				{
					o->Scale = 1.0f;
					o->LifeTime = 10.0f / Models[o->Owner->Type].Actions[PLAYER_SKILL_THRUST].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
				}
				else if (o->SubType == 1)
				{
					o->Velocity = 0.1f;
			...
			case MODEL_DOWN_ATTACK_DUMMY_R:
			{
				...
				o->LifeTime = 100;
				Models[MODEL_DOWN_ATTACK_DUMMY_L].Actions[0].PlaySpeed = Models[o->Owner->Type].Actions[PLAYER_SKILL_STAMP].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
				Models[MODEL_DOWN_ATTACK_DUMMY_R].Actions[0].PlaySpeed = Models[o->Owner->Type].Actions[PLAYER_SKILL_STAMP].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
			}
			break;
			...
			case MODEL_SHOCKWAVE01:
			{
				...
				if (o->SubType == 1)
				{
					o->Velocity = Models[o->Owner->Type].Actions[PLAYER_SKILL_DRAGONLORE].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
			...
			case MODEL_SHOCKWAVE_SPIN01:
			{
				o->Scale = Scale;
				VectorCopy(Light, o->Light);
				o->Velocity = Models[o->Owner->Type].Actions[PLAYER_SKILL_GIANTSWING].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
			...
			case MODEL_WOLF_HEAD_EFFECT2:
			{
				...
				if (o->SubType == 3 || o->SubType == 5)
				{
					...
					o->LifeTime = 4.0f / Models[o->Owner->Type].Actions[PLAYER_SKILL_GIANTSWING].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
				}
				else if (o->SubType == 4)
				{
					o->Velocity = 0.1f;
			...
			case MODEL_DRAGON_KICK_DUMMY:
			{
				...
				// ani keyframe 10 : 19
				o->LifeTime = 200;
				Models[MODEL_DRAGON_KICK_DUMMY].Actions[0].PlaySpeed = Models[o->Owner->Type].Actions[PLAYER_SKILL_DRAGONKICK].PlaySpeed * static_cast<float>(FPS_ANIMATION_FACTOR);
